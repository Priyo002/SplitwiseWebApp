...
const resp1 = document.getElementById("register").addEventListener('click',async ()=>{
    ...
    if(data.status<400){
        window.location.href = './Frontend/afterLogin.html';
    }
})
...
// const resp3 = document.getElementById("register").addEventListener('click',async ()=>{
//     const email = document.getElementById("email").value;
//     const username = document.getElementById("username").value;
//     const password = document.getElementById("password").value;
//     console.log(email);
//     console.log(username);
//     console.log(password);
//     const data = await fetch("http://localhost:3000/api/v1/users/demo",{
//         method: "GET",
//         // body:JSON.stringify({
//         //     username: username,
//         //     email: email,
